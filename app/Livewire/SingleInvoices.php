...
class SingleInvoices extends Component
{
    ...
    public $price, $discount_value = 0, $patient_id, $doctor_id, $section_id, $type, $Service_id, $single_invoice_id, $catchError, $Total_after_discount;
    public $username;
    ...
    public function render()
    {
        return view('livewire.single_invoices.single-invoices',  [
            ...
            'subtotal' => $this->Total_after_discount,
            'tax_value' => $this->Total_after_discount * ((is_numeric($this->tax_rate) ? $this->tax_rate : 0) / 100)
        ]);
    }

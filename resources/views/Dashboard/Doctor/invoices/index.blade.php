...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('doctor-dashboard_trans.invoices_page_title') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    {{ trans('doctor-dashboard_trans.breadcrumb_invoices') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                                        data-target="#add_diagnosis{{ $invoice->id }}"><i
                                                            class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp;{{ trans('doctor-dashboard_trans.action_add_diagnosis') }}
                                                         </a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                                        data-target="#add_review{{ $invoice->id }}"><i
                                                            class="text-warning far fa-file-alt"></i>&nbsp;&nbsp;{{ trans('doctor-dashboard_trans.action_add_review') }}
                                                         </a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                                        data-target="#xray_conversion{{ $invoice->id }}"><i
                                                            class="text-primary fas fa-x-ray"></i>&nbsp;&nbsp;{{ trans('doctor-dashboard_trans.action_convert_to_xray') }}
                                                         </a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                                        data-target="#laboratorie_conversion{{ $invoice->id }}"><i
                                                            class="text-warning fas fa-syringe"></i>&nbsp;&nbsp;{{ trans('doctor-dashboard_trans.action_convert_to_lab') }}
                                                         </a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                                        data-target="#delete"><i
                                                            class="text-danger  ti-trash"></i>&nbsp;&nbsp;{{ trans('doctor-dashboard_trans.action_delete_data') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>

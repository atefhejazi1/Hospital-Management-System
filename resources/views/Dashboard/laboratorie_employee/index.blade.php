...
@section('title')
   {{ trans('staff-crud_trans.index_title') }}
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('staff-crud_trans.laboratory_section') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">{{ trans('staff-crud_trans.breadcrumb_index') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add">
                                           {{ trans('staff-crud_trans.add_employee_button') }}
                                        </button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th>{{ trans('staff-crud_trans.col_name') }}</th>
                                                <th >{{ trans('staff-crud_trans.col_email') }}</th>
                                                <th>{{ trans('staff-crud_trans.col_created_at') }}</th>
                                                <th >{{ trans('staff-crud_trans.col_actions') }}</th>
                                            </tr>
                                            </thead>
                                            <tbody>

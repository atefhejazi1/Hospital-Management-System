...
@section('title')
    {{ trans('billing-ops_trans.payment_index_title') }}
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('billing-ops_trans.payment_breadcrumb_section') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">{{ trans('billing-ops_trans.payment_breadcrumb_index') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                           ...
                                           @foreach($payments as $payment)
                                               <tr>
                                                   ...
                                                   <td>
                                                       ...
                                                       <a href="{{route('Payment.show',$payment->id)}}" class="btn btn-primary btn-sm" target="_blank" title="{{ trans('billing-ops_trans.payment_print_tooltip') }}"><i class="fas fa-print"></i></a>

...
@section('title')
    {{ trans('billing-ops_trans.receipt_edit_title') }}
@stop
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('billing-ops_trans.payment_breadcrumb_section') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">{{ trans('billing-ops_trans.receipt_breadcrumb_edit') }} </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label>{{ trans('billing-ops_trans.payment_patient_name') }}</label>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label>{{ trans('billing-ops_trans.payment_amount') }}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label>{{ trans('billing-ops_trans.payment_description') }}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">

...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">{{ trans('patient-dashboard_trans.dashboard_title') }}</h2><br>
						  <p class="mg-b-0">{{ trans('patient-dashboard_trans.welcome_back', ['name' => auth()->user()->name]) }}</p>
						</div>
					</div>
				</div>
				<!-- /breadcrumb -->
				...
				<div class="row row-sm">
					<div class="col-xl-6 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{ trans('patient-dashboard_trans.total_invoices') }}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">{{ trans('patient-dashboard_trans.total_payments') }}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <div class="card card-table-two">
                            <div class="d-flex justify-content-between">
                                <h2 class="card-title mb-1">{{ trans('patient-dashboard_trans.latest_invoices_title') }}</h2>
                            </div><br>
                            <div class="table-responsive country-table">
                                <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ trans('patient-dashboard_trans.col_patient_name') }}</th>
                                    ...
                                    @forelse(\App\Models\Invoice::latest()->take(5)->where('patient_id',auth()->user()->id)->get() as $invoice )
                                        <tr>
                                            ...
                                            <td class="tx-right tx-medium tx-inverse">
                                                @if($invoice->case == 0)
                                                    <span class="badge badge-danger">{{ trans('patient-dashboard_trans.status_in_progress') }}</span>
                                                @else
                                                    <span class="badge badge-success">{{ trans('patient-dashboard_trans.status_completed') }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @empty

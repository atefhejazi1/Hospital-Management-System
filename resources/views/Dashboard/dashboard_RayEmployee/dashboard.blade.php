...
@section('title', trans('staff-dashboard_trans.ray_dashboard_title'))
...
<div class="mc-page d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
    <div class="mc-greeting">
        ...
        <p>{{ now()->translatedFormat('l, d F Y') }} — {{ trans('staff-dashboard_trans.greeting_subtitle') }}</p>
    </div>
    ...
    <div class="row row-sm mb-1">
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="mc-metric-card">
                ...
                <div class="mc-metric-label">{{ trans('staff-dashboard_trans.pending_queue_count') }}</div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="mc-metric-card">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="mc-metric-card">
                ...
                <div class="mc-metric-value">{{ $metrics['totalRays'] }}</div>
                <div class="mc-metric-label">{{ trans('staff-dashboard_trans.total_rays_count') }}</div>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-7 col-lg-12">
            <div class="mc-panel">
                <div class="mc-panel-head">
                    <div>
                        <h4 class="mc-panel-title">{{ trans('staff-dashboard_trans.trend_title') }}</h4>
            ...
            <div class="mc-panel">
                <div class="mc-panel-head">
                    <div>
                        ...
                        <p class="mc-panel-sub">{{ trans('staff-dashboard_trans.status_breakdown_sub') }}</p>
                    </div>
                </div>
                ...
                <div class="mc-donut-wrap">
                    ...
                    <div class="mc-donut-total">
                        ...
                        <div class="lbl">{{ trans('staff-dashboard_trans.rays_suffix') }}</div>
                    </div>
                </div>
    ...
    <div class="row row-sm mt-3">
        <div class="col-12">
            <div class="mc-panel">
                <div class="mc-panel-head">
                    <div>
                        <h4 class="mc-panel-title">{{ trans('staff-dashboard_trans.recent_completed_title') }}</h4>
                ...
                @if ($recentCompleted->isEmpty())
                    <div class="mc-empty">
                        ...
                        {{ trans('staff-dashboard_trans.no_completed_scans') }}
                    </div>
                @else
                    <div class="table-responsive">
                        <table class="mc-table w-100">
                            ...
                            <tbody>
                                @foreach ($recentCompleted as $ray)
                                    <tr>
                                        <td>{{ $ray->Patient->name ?? '-' }}</td>
                                        <td>{{ $ray->doctor->name ?? '-' }}</td>
                                        <td>{{ $ray->description }}</td>
                                        <td>{{ $ray->updated_at->format('Y-m-d h:i A') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>

...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('staff-dashboard_trans.lab_images_title') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
...
@section('content')
    ...
    <div class="form-group">
        <label for="exampleFormControlTextarea1">{{ trans('staff-dashboard_trans.lab_doctor_notes_label') }}</label>

...
@section('title')
    {{ trans('staff-dashboard_trans.lab_checkups_title') }}
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('staff-dashboard_trans.lab_checkups_title') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('staff-dashboard_trans.lab_checkups_breadcrumb') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{route('invoices_laboratorie_employee.edit',$invoice->id)}}"><i class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp;{{ trans('staff-dashboard_trans.add_diagnosis_action') }}</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
